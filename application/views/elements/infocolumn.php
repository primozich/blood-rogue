<div class="info_col" style="float:left;font-weight:bold;width:215px;">
	<div style="margin-top:20px;">
		<div class="grayText" style="margin-left:10px;float:left;width:100px;">Dungeon Level</div>
		<div style="float:right;margin-right:15px;"><?php echo $dungeonLevel; ?></div>
	</div>
	<div style="clear:both;"></div>
	<div style="margin-top:20px;">
		<div class="grayText" style="margin-left:10px;float:left;width:50px;">Level/XP</div>
		<div style="float:right;margin-right:15px;"><?php echo $playerLevel; ?> / <?php echo $xp; ?></div>
	</div>
	<div style="clear:both;"></div>
	<div style="margin-top:20px;">
		<div class="grayText" style="margin-left:10px;float:left;width:100px;">Gold</div>
		<div style="float:right;margin-right:15px;"><?php echo $gold; ?></div>
	</div>
	<div style="clear:both;"></div>
	<div style="margin-top:20px;">
		<div class="grayText" style="margin-left:10px;float:left;width:100px;">Hit Points</div>
		<div style="float:right;margin-right:15px;"><?php echo $hit_points; ?> / <?php echo $hit_points_max; ?></div>
	</div>
	<div style="clear:both;"></div>
	<div style="margin-top:20px;">
		<div class="grayText" style="margin-left:10px;float:left;width:100px;">Strength</div>
		<div style="float:right;margin-right:15px;"><?php echo $strength; ?> / <?php echo $strength_max; ?></div>
	</div>
	<div style="clear:both;"></div>
	<div style="margin-top:20px;">
		<div class="grayText" style="margin-left:10px;float:left;width:100px;">- - - - - - - - - - - </div>
	</div>
	<div style="clear:both;"></div>
	<div style="margin-top:20px;">
		<?php
		...
		?>
				<div style="clear:both;"></div>
				<div class="grayText" style="margin-left:10px;margin-bottom:7px;margin-top:10px;width:100px;">Equipment</div>
		<?php 
					if (!$hasEquipment)
					{
		...
		?>
				<div style="clear:both;"></div>
				<div class="grayText" style="margin-left:10px;margin-bottom:7px;margin-top:10px;width:100px;">Potions</div>
		<?php 
					if (!$hasPotions)
					{
				...
				{
		?>	
				<div style="margin-left:15px;float:left;width:130px;font-weight:normal;"><a class="whiteText" target="_top" href="http://<?php echo $env->www_root; ?>/rogue/use/<?php echo $key; ?>"><?php echo $item->getName(); ?></a></div>
		<?php
				}
				$itemCount++;
			} 
		...
		?>
				<div style="clear:both;"></div>
				<div class="grayText" style="margin-left:10px;margin-bottom:7px;margin-top:10px;width:100px;">Scrolls</div>
		<?php 
					if (!$hasScrolls)
					{
		...
		?>
				<div style="clear:both;"></div>
				<div class="grayText" style="margin-left:10px;margin-bottom:7px;margin-top:10px;width:100px;">Food</div>
		<?php 
					if (!$hasFood)
					{
	...
	<div style="clear:both;"></div>
	<div class="grayText" style="margin-top:20px;border:1px solid #aaaaaa;margin-left:15px;padding:5px;width:150px;">
